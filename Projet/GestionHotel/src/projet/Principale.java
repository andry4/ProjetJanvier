...
public class Principale {
	...
	public static void main(String[] args) {
		...
		//Déroulement du jeu
		int i=0;
		int choix; //Choix sur l'étage qui va etre acheté
		...
		while(i<15){
			...
			System.out.println("4 Discothèque \t prix : "+Discotheque.getPrixachat());
			System.out.println("5 Piscine \t prix : "+Piscine.getPrixachat());
			System.out.println("6 Restaurant \t prix : "+Restaurant.getPrixachat());
			System.out.println("7 Salle de sport \t prix : "+SalleSport.getPrixachat());
			while(rep=='o'||rep=='O'){
				System.out.println("Votre solde est de "+hotel.getSolde());
				//Choix d'achat 
				choix=scInt.nextInt();
				...
				case 6 : {
					if(hotel.getSolde()>=Restaurant.getPrixachat()){
						etage[i] = new Restaurant();
						hotel.acheterEtage(Restaurant.getPrixachat());
						hotel.ajouterEtage();
						i++;
					}else System.out.println("Votre solde n'est pas suffisant");
					break;
				...
				case 7 : {
					if(hotel.getSolde()>=SalleSport.getPrixachat()){
						etage[i] = new SalleSport();
						hotel.acheterEtage(SalleSport.getPrixachat());
						hotel.ajouterEtage();
						i++;
					}else System.out.println("Votre solde n'est pas suffisant");
					break;
				...
				System.out.println("Vous voulez encore acheter un étage (O si OUI)");
